<template>
  <div class="vehicles">
    ...
    <Contact @sendMess="sendMess" :regContent="regContent" :nameReg="nameReg" :emailReg="emailReg" :contentReg="contentReg"><p class="slogan">Let us know if you wanna book.<em>Email us</em></p></Contact>
