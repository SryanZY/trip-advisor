<template>
  <div class="trains">
    ...
    <Contact @sendMess="sendMess" :regContent="regContent" :nameReg="nameReg" :emailReg="emailReg" :contentReg="contentReg"><p class="slogan">Let us know if you wanna book one.<em>Email us</em></p></Contact>
